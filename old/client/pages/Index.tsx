        ...
        <div className="flex-1 flex flex-col px-6 pb-12 pt-0 relative">
          ...
          <div className="flex gap-4 mb-6">
            <button className="flex-1 h-14 flex items-center justify-center gap-2 rounded-2xl border border-[#8B5E3C]/30 bg-[#8B5E3C]/10 text-[#FEFAE0] text-sm font-semibold hover:bg-[#8B5E3C]/20 transition-colors">
              ...
              >
                <path
                  d="M17.16 9.20388C17.16 14.1785 13.7526 17.7187 8.72066 17.7187C3.89616 17.7187 0 13.8234 0 8.99997C0 4.17655 3.89616 0.28125 8.72066 0.28125C11.0696 0.28125 13.0458 1.14258 14.5684 2.56288L12.1949 4.84452C9.08988 1.84921 3.31596 4.09921 3.31596 8.99997C3.31596 12.041 5.74579 14.5054 8.72066 14.5054C12.1738 14.5054 13.4678 12.0304 13.6717 10.7472H8.72066V7.74841H17.0229C17.1037 8.1949 17.16 8.6238 17.16 9.20388Z"
                  fill="#FEFAE0"
                />
              </svg>
              Google
          ...
          <div className="flex items-center justify-center gap-1">
            ...
            <Link
              to="/login"
              className="text-[#F4A261] text-sm font-bold leading-5 border-b border-[#F4A261]/20 hover:border-[#F4A261]/60 transition-colors pb-px"
            >
              Log in
            </Link>
          </div>

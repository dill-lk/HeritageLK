  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] flex justify-center pb-4 pointer-events-none">
      <div className="pointer-events-auto w-[360px] h-[84px] rounded-[42px] border border-[#F4A261]/20 bg-[#231B12]/60 backdrop-blur-xl shadow-[0_24px_48px_rgba(0,0,0,0.55)] flex items-center px-2 gap-1">
        ...
        <Link
          to="/home"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isHome ? "opacity-100" : "opacity-40"}`}
        >
          <svg
          ...
          >
            <path
              ...
              fill={isHome ? "#F4A261" : "white"}
            />
          </svg>
          <span
            className={`text-[10px] font-bold uppercase leading-[15px] ${isHome ? "text-[#F4A261]" : "text-white"}`}
          >
            Home
          </span>
        </Link>
        ...
        <Link
          to="/explore"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isExplore ? "opacity-100" : "opacity-40"}`}
        >
          <svg
            className="h-[22px] w-auto"
            viewBox="0 0 23 20"
          ...
          >
            <path
              ...
              fill={isExplore ? "#F4A261" : "white"}
            />
          </svg>
          <span
            className={`text-[10px] font-bold uppercase leading-[15px] ${isExplore ? "text-[#F4A261]" : "text-white"}`}
          >
            Explore
          </span>
        </Link>
        ...
        <Link
          to="/scanner"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isScanner ? "opacity-100" : "opacity-40"}`}
        >
          <svg
            className="h-[22px] w-auto"
            viewBox="0 0 24 24"
          ...
          >
            <path
              ...
              fill={isScanner ? "#F4A261" : "white"}
            />
          </svg>
          <span
            className={`text-[10px] font-bold uppercase leading-[15px] ${isScanner ? "text-[#F4A261]" : "text-white"}`}
          >
            Camera
          </span>
        </Link>
        ...
        <Link
          to="/quests"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isQuests ? "opacity-100" : "opacity-40"}`}
        >
          <svg
            className="h-[22px] w-auto"
            viewBox="0 0 20 20"
        ...
        <Link
          to="/archive"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isArchive ? "opacity-100" : "opacity-40"}`}
        >
          <svg
            className="h-[22px] w-auto"
            viewBox="0 0 18 20"
        ...
        <Link
          to="/archive/shingo"
          className={`flex-1 flex flex-col items-center justify-center gap-1 transition-opacity ${isShingo ? "opacity-100" : "opacity-40"}`}
        >
          <ShingoLogo
            className={`h-[22px] w-auto ${isShingo ? "text-[#F4A261]" : "text-white"}`}
          />
          <span
            className={`text-[10px] font-bold uppercase leading-[15px] ${isShingo ? "text-[#F4A261]" : "text-white"}`}
          >
            Shingo
          </span>
        </Link>

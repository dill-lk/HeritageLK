...
class _SignupScreenState extends State<SignupScreen> {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FilledButton(
                          ...
                          style: FilledButton.styleFrom(
                            ...
                            disabledBackgroundColor: HeritageColors.orange.withValues(alpha:0.55),
                      ...
                      Row(
                        children: [
                          Expanded(child: Divider(color: HeritageColors.brown.withValues(alpha:0.20))),
  ...
  InputDecoration _decoration(String hint, IconData icon) => InputDecoration(hintText: hint, hintStyle: TextStyle(color: HeritageColors.brown.withValues(alpha:0.50)), prefixIcon: Icon(icon, color: HeritageColors.brown, size: 18), filled: true, fillColor: HeritageColors.brown.withValues(alpha:0.10), enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: HeritageColors.brown.withValues(alpha:0.30)), borderRadius: BorderRadius.circular(16)), focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: HeritageColors.orange.withValues(alpha:0.50)), borderRadius: BorderRadius.circular(16)));

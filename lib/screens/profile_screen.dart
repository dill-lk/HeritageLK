              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _round(Icons.settings, () => Navigator.of(context).pushNamed('/settings')),
                  ],
                ),
                        ...
                        children: [
                          ClipOval(
                            child: Image.network(
                              ...
                              height: 128,
                              fit: BoxFit.cover,
                              errorBuilder: (_, __, ___) => const CircleAvatar(radius: 64, backgroundColor: HeritageColors.brown, child: Icon(Icons.person, color: HeritageColors.cream, size: 48)),
                            ),
                          ),
                          Positioned(
                            right: 4,
                            ...
                            child: Container(
                              width: 32,
                              height: 32,
                              decoration: BoxDecoration(color: const Color(0xFF52B788), border: Border.all(color: HeritageColors.background, width: 3), shape: BoxShape.circle),
                              child: const Icon(Icons.edit_square, color: HeritageColors.background, size: 15),
                            ),
                          ),
                        ],
                      ),
                ...
                SizedBox(
                  ...
                  child: _completed.isEmpty
                      ? const Align(alignment: Alignment.centerLeft, child: Text('Complete quests to unlock achievements!', style: TextStyle(color: Color(0x80FFFFFF), fontSize: 14)))
                      : ListView.separated(scrollDirection: Axis.horizontal, itemCount: _completed.length, separatorBuilder: (_, __) => const SizedBox(width: 12), itemBuilder: (_, index) => _achievement(_completed[index])),
                ),
                const SizedBox(height: 28),
                ...
                SizedBox(
                  height: 150,
                  child: _completed.isEmpty
                      ? const Align(alignment: Alignment.centerLeft, child: Text('No recent discoveries.', style: TextStyle(color: Color(0x80FFFFFF), fontSize: 14)))
                      : ListView.separated(scrollDirection: Axis.horizontal, itemCount: _completed.length, separatorBuilder: (_, __) => const SizedBox(width: 14), itemBuilder: (_, index) => _discovery(_completed[index], index)),
                ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(border: Border.all(color: const Color(0x33E76F51)), borderRadius: BorderRadius.circular(24)),
                    child: const Center(child: Text('Log Out', style: TextStyle(color: Color(0xFFE76F51), fontWeight: FontWeight.bold))),
                  ),
                ),
              ],
            ),

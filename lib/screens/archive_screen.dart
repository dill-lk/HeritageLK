      ...
      body: SafeArea(
        child: Stack(children: [
          ListView(padding: const EdgeInsets.fromLTRB(24, 12, 24, 140), children: [
            ...
            SingleChildScrollView(scrollDirection: Axis.horizontal, child: Row(children: List.generate(_tabs.length, (i) => Padding(padding: const EdgeInsets.only(right: 8), child: GestureDetector(onTap: () => setState(() => _tab = i), child: Container(padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10), decoration: BoxDecoration(color: _tab == i ? HeritageColors.orange : Colors.white.withOpacity(0.05), borderRadius: BorderRadius.circular(99), boxShadow: _tab == i ? [BoxShadow(color: HeritageColors.orange.withOpacity(0.40), blurRadius: 15)] : null), child: Text(_tabs[i], style: TextStyle(color: _tab == i ? HeritageColors.background : const Color(0x99FFFFFF), fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5))))))),
            const SizedBox(height: 24),
            if (featured != null) ...[
              Row(children: [

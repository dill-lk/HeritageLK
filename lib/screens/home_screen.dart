            ...
            ListView(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: HeritageColors.orange.withValues(alpha: 0.10),
                ...
                _HomeCard(
                  ...
                  subtitle: 'Help us preserve our heritage by reporting any issues you see.',
                  color: HeritageColors.orange,
                  onTap: () => Navigator.of(context).pushNamed('/report-damage'),
                ),
                ...
                _BannerCard(
                  ...
                  onTap: () => Navigator.of(context).pushNamed('/archive/shingo'),
                ),
                const SizedBox(height: 16),
                _BannerCard(
                  emoji: '🏨',
                ...
                _BannerCard(
                  ...
                  subtitle: 'Collect stamps, track your pathfinder rank, and share your cultural journey offline.',
                  borderColor: HeritageColors.orange,
                  bgColor: HeritageColors.orange,
                  onTap: () => Navigator.of(context).pushNamed('/passport'),
                ),
                ...
                Row(
                  ...
                  children: [
                    Text('Places to Explore', style: GoogleFonts.plusJakartaSans(color: HeritageColors.cream, fontSize: 28, fontWeight: FontWeight.bold)),
                    GestureDetector(
                ...
                const SizedBox(height: 16),
                if (_placesToExplore.length >= 4) ...[
                  Row(
                    children: [
                      Expanded(child: _NearbyCard(emoji: _placesToExplore[0]['emoji']!, name: _placesToExplore[0]['name']!, distance: _placesToExplore[0]['distance']!, onTap: () => Navigator.of(context).pushNamed('/explore'))),
                      const SizedBox(width: 12),
                      Expanded(child: _NearbyCard(emoji: _placesToExplore[1]['emoji']!, name: _placesToExplore[1]['name']!, distance: _placesToExplore[1]['distance']!, onTap: () => Navigator.of(context).pushNamed('/explore'))),
                    ],
                  ),
                  const SizedBox(height: 12),
                  Row(
                    children: [
                      Expanded(child: _NearbyCard(emoji: _placesToExplore[2]['emoji']!, name: _placesToExplore[2]['name']!, distance: _placesToExplore[2]['distance']!, onTap: () => Navigator.of(context).pushNamed('/explore'))),
                      const SizedBox(width: 12),
                      Expanded(child: _NearbyCard(emoji: _placesToExplore[3]['emoji']!, name: _placesToExplore[3]['name']!, distance: _placesToExplore[3]['distance']!, onTap: () => Navigator.of(context).pushNamed('/explore'))),
                    ],
                  ),
                ],
              ],
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0x2652B788)),
            shape: BoxShape.circle,
          ),
          child: Icon(icon, color: HeritageColors.cream, size: 20),
        ),
      );
}

class _StatPill extends StatelessWidget {
  const _StatPill({required this.icon, required this.color, required this.text});
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white.withValues(alpha: 0.05),
          border: Border.all(color: const Color(0x3352B788)),
        ...
        child: Row(
          ...
          children: [
            ...
            Text(text, style: const TextStyle(color: HeritageColors.cream, fontSize: 14, fontWeight: FontWeight.w500)),
          ],
        ),
      );
}
...
class _HomeCard extends StatelessWidget {
  const _HomeCard({required this.icon, required this.title, required this.subtitle, required this.color, required this.onTap});
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: const TextStyle(color: HeritageColors.cream, fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Text(subtitle, style: const TextStyle(color: Color(0x99FEFAE0), fontSize: 12)),
                  ],
                ),
              ),
              Container(
...
class _GridCard extends StatelessWidget {
  const _GridCard({required this.emoji, required this.title, required this.subtitle, required this.borderColor, required this.onTap});
...
class _SmallGridCard extends StatelessWidget {
  const _SmallGridCard({required this.emoji, required this.title, required this.borderColor, required this.onTap});
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    width: 24,
                    height: 24,
                    decoration: BoxDecoration(color: borderColor.withValues(alpha: 0.20), shape: BoxShape.circle),
                    child: Icon(Icons.arrow_forward_ios, color: borderColor, size: 10),
                  ),
                ],
              ),
              Text(title, style: const TextStyle(color: HeritageColors.cream, fontSize: 16, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
      );
...
class _BannerCard extends StatelessWidget {
  const _BannerCard({required this.emoji, required this.title, required this.subtitle, required this.borderColor, required this.bgColor, required this.onTap});
          ...
          child: Row(
            children: [
              Container(
                width: 60,
                height: 60,
                decoration: BoxDecoration(color: bgColor.withValues(alpha: 0.20), shape: BoxShape.circle),
...
class _NearbyCard extends StatelessWidget {
  const _NearbyCard({required this.emoji, required this.name, required this.distance, this.onTap});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(name, style: const TextStyle(color: HeritageColors.cream, fontSize: 18, fontWeight: FontWeight.w600)),
              const SizedBox(height: 4),
              Text(distance, style: const TextStyle(color: Color(0x80FEFAE0), fontSize: 13)),
            ],
          ),
        ),
      );

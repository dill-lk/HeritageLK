        ...
        child: Stack(children: [
          ListView(padding: const EdgeInsets.fromLTRB(24, 24, 24, 130), children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              InkWell(onTap: () => Navigator.of(context).pushReplacementNamed('/home'), borderRadius: BorderRadius.circular(24), child: Container(width: 40, height: 40, decoration: BoxDecoration(color: Colors.white.withValues(opacity:0.05), shape: BoxShape.circle), child: const Icon(Icons.arrow_back, color: HeritageColors.orange))),
              Text(title, style: const TextStyle(color: HeritageColors.cream, fontFamily: 'Playfair Display', fontSize: 22)),
              const SizedBox(width: 40),
            ]),
            const SizedBox(height: 42),
            Container(height: 230, decoration: BoxDecoration(color: HeritageColors.brown.withValues(opacity:0.14), border: Border.all(color: HeritageColors.brown.withValues(opacity:0.30)), borderRadius: BorderRadius.circular(24)), child: Center(child: Icon(icon, color: HeritageColors.orange, size: 72))),

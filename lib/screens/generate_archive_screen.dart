      ...
      child: ListView(
        ...
        children: [
          ...
          if (_result.isNotEmpty) ...[
            const SizedBox(height: 24),
            Container(padding: const EdgeInsets.all(18), decoration: BoxDecoration(color: Colors.white.withValues(alpha:0.05), border: Border.all(color: Colors.white.withValues(alpha:0.08)), borderRadius: BorderRadius.circular(20)), child: Text(_result, style: const TextStyle(color: Color(0xCCFFFFFF), fontSize: 14, height: 1.6))),
            const SizedBox(height: 16),
